	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Marker': [
			{
				type_point: 'Fort',
				name: 'Shivneri Fort',
				location_latitude: 19.2067958, 
				location_longitude: 73.8106493,
				map_image_url: 'img/mapImage.jpg',
				rate: 'Superb | 9.5',
				name_point: 'Shivneri Fort',
			...
			var mapOptions = {
				zoom: 14,
				center: new google.maps.LatLng(19.2067958, 73.8106493),
